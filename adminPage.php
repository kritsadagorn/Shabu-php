...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=lunch_dining" />
    <style>
...
<body class="bg-gray-100">
    <div style="position: fixed; top: 20px; right: 20px; z-index: 1000;">
        <button id="addfoodbutton" class="bg-slate-900 hover:scale-105 hover:bg-blue-950"
            style="color: #848bbf;  border-radius: 50%; width: 70px; height: 70px; border: none;"
            onclick="window.location.href='addfood.php';">
